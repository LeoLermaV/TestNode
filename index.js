...
function CreateInvoiceWithOneItem() {
    ...
    console.log('Create Invoice With One Item '+invoice.GetTotal());
}
...
function CreateInvoiceWithMultipleItemsAndQuantities () {
    ...
    console.log('Create Invoice With Multiple Items And Quantities '+ invoice.GetTotal());
}
...
function RemoveItem() {
    ...
    console.log('Remove Item '+ invoice.GetTotal());
}
...
function MergeInvoices() {
    ...
    console.log('Merge Invoices '+invoice1.GetTotal());
}
...
function CloneInvoice() {
    ...
    console.log('Clone Invoice '+clonedInvoice.GetTotal());
